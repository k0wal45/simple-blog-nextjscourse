    ...
    <section className={classes.contact}>
      ...
      <form className={classes.form} onSubmit={sendMessageHandler}>
        ...
        <div className={classes.control}>
          ...
          <textarea id="message" rows={5} value={enteredMessage} onChange={(event) => setEnteredMessage(event.target.value)}>
      ...
      {
        notificaton && (
          <Notification title={notificaton.title} status={notificaton.status} message={notificaton.message}/>
        )
      }
    </section>
  )
